    ...
    <nav style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <Link href="/about" 
            style={{ color: colors.warmGray[700], textDecoration: 'none', fontSize: '0.95rem', fontWeight: 500, transition: 'color 0.2s ease', paddingBottom: '0.25rem', borderBottom: `2px solid transparent` }}
            onMouseEnter={(e) => {
              const target = e.currentTarget as HTMLElement
              target.style.color = colors.sage[600]
