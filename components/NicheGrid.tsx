...
const specialties = [
  ...
  },
  {
    ...
    title: 'Grief & Loss',
    icon: '💙',
    description: 'Loss comes in many forms. Whether it\'s recent or long-held, grief deserves space and witness.',
    link: '/grief',
    color: colors.sage[600],
  },
  {
    ...
    icon: '💑',
    description: 'Relationships evolve. We can rebuild connection, clarify needs, and move forward together.',
    link: '/couples',
    color: colors.sage[600],
  },
  {
    ...
    icon: '👨',
    description: 'Masculinity shapes what you can ask for. Let\'s rewrite what therapy looks like for you.',
    link: '/men',
    color: colors.sage[600],
  },
  {
    ...
    icon: '👨‍👩‍👧‍👦',
    description: 'Parenting is one of the most rewarding—and most overwhelming—things you\'ll do.',
    link: '/parents',
    color: colors.sage[600],
  },
  {
    ...
    title: 'LGBTQ+ Therapy',
    icon: '🏳️‍🌈',
    description: 'Your identity and lived experience matter. Therapy that affirms all of who you are.',
    link: '/lgbtq',
    color: colors.sage[600],
  },
  {
    ...
    title: 'BIPOC Therapy',
    icon: '🌍',
    description: 'Race, culture, and identity shape your mental health journey. We\'ll honor that context.',
    link: '/bipoc',
    color: colors.sage[600],
  },
  {
    ...
    icon: '🧩',
    description: 'Autism, ADHD, dyslexia—your neurodiversity isn\'t something to fix, it\'s something to understand.',
    link: '/neurodivergent',
    color: colors.sage[600],
  },
]
