  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <section className="section-padding bg-cream-50">
          <div className="container-base max-w-3xl mx-auto">
            ...
            <div className="space-y-6 text-warm-gray-600">
              ...
              <div className="bg-white p-6 rounded-lg border-l-4" style={{borderLeftColor: '#d8a574'}}>
                <p className="font-semibold text-warm-gray-900 mb-4" style={{color: '#d8a574'}}>
                  Common triggers:
                </p>
        ...
        {/* For Parents */}
        <section className="section-padding bg-white border-t-4" style={{borderTopColor: '#d8a574'}}>
          <div className="container-base max-w-3xl mx-auto">
            <IconHeading icon="👨‍👩‍👧" level={2} color={colors.warmGray[900]}>
            ...
            <div className="space-y-6 text-warm-gray-600">
              ...
              <div className="p-8 rounded-lg border-l-4" style={{backgroundColor: 'rgba(216, 165, 116, 0.08)', borderLeftColor: '#d8a574'}}>
                <p className="font-semibold text-warm-gray-900" style={{color: '#d8a574'}}>
        ...
        <section className="section-padding bg-white">
          <div className="container-base max-w-3xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-2xl mx-auto mb-8">
              <div className="text-center p-6 rounded-lg" style={{backgroundColor: 'rgba(216, 165, 116, 0.1)'}}>
                <p className="text-4xl font-bold mb-2" style={{color: '#d8a574'}}>32%</p>
                <p className="text-warm-gray-600">
              ...
              <div className="text-center p-6 rounded-lg" style={{backgroundColor: 'rgba(216, 165, 116, 0.1)'}}>
                <p className="text-4xl font-bold mb-2" style={{color: '#d8a574'}}>4-8</p>
                <p className="text-warm-gray-600">
            ...
            <div className="bg-cream-50 border-l-4 p-6 rounded" style={{borderLeftColor: '#d8a574'}}>
        ...
        <section className="section-padding text-white" style={{backgroundColor: '#d8a574'}}>
          <div className="container-base text-center">
            ...
            <Link href="/booking" className="inline-block bg-white px-8 py-4 font-semibold rounded-lg hover:bg-opacity-90" style={{color: '#d8a574'}}>
