      ...
      <main className="flex-grow">
        ...
        <section className="hero-section py-20" style={{background: 'linear-gradient(135deg, rgba(242, 245, 250, 1) 0%, rgba(248, 250, 247, 1) 100%)'}}>
          <div className="container-base text-center animate-fade-in-up">
            ...
            <p className="text-xl font-semibold mb-4 max-w-2xl mx-auto" style={{color: '#4a6fa5'}}>
        ...
        <section className="section-padding bg-white">
          <div className="container-base max-w-3xl mx-auto">
            ...
            <div className="mb-8 p-6 rounded-lg border-l-4" style={{backgroundColor: 'rgba(74, 111, 165, 0.08)', borderLeftColor: '#4a6fa5'}}>
          ...
          <div className="container-base max-w-3xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                <div key={index} className="p-5 rounded-lg" style={{backgroundColor: 'rgba(74, 111, 165, 0.08)'}}>
                  <h3 className="font-serif font-bold text-warm-gray-900 mb-2" style={{color: '#4a6fa5'}}>
                    {item.title}
                  </h3>
        ...
        <section className="section-padding bg-white">
          <div className="container-base max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="p-6 rounded-lg border-l-4" style={{backgroundColor: 'rgba(74, 111, 165, 0.08)', borderLeftColor: '#4a6fa5'}}>
                <h3 className="text-xl font-serif font-bold text-warm-gray-900 mb-2" style={{color: '#4a6fa5'}}>
                  You're in Control
                </h3>
        ...
        <section className="section-padding bg-sage-50">
          <div className="container-base max-w-3xl mx-auto">
            ...
            <div className="space-y-6 text-warm-gray-600">
              <div className="p-6 rounded-lg" style={{backgroundColor: 'rgba(74, 111, 165, 0.08)'}}>
                <h3 className="text-xl font-serif font-bold text-warm-gray-900 mb-2" style={{color: '#4a6fa5'}}>
        ...
        <section className="section-padding bg-white">
          <div className="container-base max-w-3xl mx-auto">
            ...
            <div className="space-y-8">
              <div className="p-6 rounded-lg border-l-4" style={{backgroundColor: 'rgba(242, 245, 250, 1)', borderLeftColor: '#4a6fa5'}}>
                ...
                <p className="font-semibold text-warm-gray-900" style={{color: '#4a6fa5'}}>
        ...
        <section className="section-padding bg-cream-50">
          <div className="container-base max-w-3xl mx-auto">
            ...
            <div className="space-y-4 text-warm-gray-600">
              ...
              <div className="mt-8 p-6 rounded-lg" style={{backgroundColor: 'rgba(74, 111, 165, 0.08)'}}>
                <p className="font-semibold text-warm-gray-900 mb-2" style={{color: '#4a6fa5'}}>Telehealth Available</p>
                <p>Sessions from home or your office. 28 states served.</p>
              </div>

              <div className="p-6 rounded-lg" style={{backgroundColor: 'rgba(74, 111, 165, 0.08)'}}>
                <p className="font-semibold text-warm-gray-900 mb-2" style={{color: '#4a6fa5'}}>Flexible Scheduling</p>
                <p>Evening and weekend appointments available.</p>
              </div>

              <div className="p-6 rounded-lg" style={{backgroundColor: 'rgba(74, 111, 165, 0.08)'}}>
                <p className="font-semibold text-warm-gray-900 mb-2" style={{color: '#4a6fa5'}}>Sliding Scale</p>
        ...
        {/* CTA */}
        <section className="section-padding text-white" style={{backgroundColor: '#4a6fa5'}}>
          <div className="container-base text-center">
            ...
            <Link href="/booking" className="inline-block bg-white px-8 py-4 font-semibold rounded-lg hover:bg-opacity-90" style={{color: '#4a6fa5'}}>
